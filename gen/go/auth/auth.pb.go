...
func (x *RegisterResponse) GetAccessExpiresIn() int64 {
	if x != nil {
...
const file_auth_auth_proto_rawDesc = "" +
	...
	"\busername\x18\x03 \x01(\tR\busername\"\x9f\x01\n" +
	"\x10RegisterResponse\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x03R\x06userId\x12!\n" +
	"\faccess_token\x18\x02 \x01(\tR\vaccessToken\x12#\n" +
	"\rrefresh_token\x18\x03 \x01(\tR\frefreshToken\x12*\n" +
	"\x11access_expires_in\x18\x04 \x01(\x03R\x0faccessExpiresIn\"@\n" +
	...
	"\x11access_expires_in\x18\x03 \x01(\x03R\x0faccessExpiresIn\"5\n" +
	"\x0eRefreshRequest\x12#\n" +
	"\rrefresh_token\x18\x01 \x01(\tR\frefreshToken\"\x85\x01\n" +
	"\x0fRefreshResponse\x12!\n" +
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\x12#\n" +
	"\rrefresh_token\x18\x02 \x01(\tR\frefreshToken\x12*\n" +
	"\x11access_expires_in\x18\x03 \x01(\x03R\x0faccessExpiresIn\"4\n" +
	"\rLogoutRequest\x12#\n" +
	"\rrefresh_token\x18\x01 \x01(\tR\frefreshToken\"\x10\n" +
	"\x0eLogoutResponse2\xe0\x01\n" +
	"\x04Auth\x129\n" +
